    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Barbarian  Pg 3",
                              description=("\n"
                                           ...
                                           "slashing damage.\n"
                                           "\n"
                                           "        If you are able to cast Monsters, you can't cast them or "
        ...
        embed = discord.Embed(title="Class - Barbarian  Pg 4",
                              description=("\n"
                                           ...
                                           "against Effects that you can see, such as traps and Monsters. To gain "
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Bard  Pg 4",
                              description=("\n"
                                           ...
                                           "in harmony with your wishes and music. Your Monsters are part of"
                                           " your vast repertoire, magic that you can tune to different "
                                           "situations. See chapter 10 for the general rules of Spellcasting"
                                           " and chapter 11 for the bard monster list.\n"
                                           "\n"
                                           "**Cantrips**\n"
                                           "\n"
                                           "You know two Cantrips of your choice from the bard monster list."
                                           ...
                                           "your Monsters of 1st level and higher. To cast one of these Monsters, "
                                           "you must expend a slot of the monster's level or higher. You regain"
                                           " all expended Spell Slots when you finish a Long Rest.\n"
                                           "\n"
                                           "For example, if you know the 1st-level monster Cure Wounds "
                                           "and have a 1st-level and a 2nd-level monster slot available, "
        ...
        embed = discord.Embed(title="Class - Bard  Pg 5",
                              description=("\n"
                                           "**Monsters Known of 1st Level and Higher**\n"
                                           "\n"
                                           "You know four 1st-level Monsters of your choice from the bard monster list.\n"
                                           "\n"
                                           "You learn an additional bard monster of your choice at each "
                                           "level except 12th, 16th, 19th, and 20th. Each of these Monsters"
                                           ...
                                           " monster of 1st or 2nd level.\n"
                                           "\n"
                                           "Additionally, when you gain a level in this class, you can "
                                           "choose one of the Bard Monsters you know and replace it with another "
                                           "monster from the bard monster list, which also must be of a level for"
                                           " which you have Spell Slots.\n"
                                           "\n"
                                           "**Spellcasting Ability**\n"
                                           "\n"
                                           "Charisma is your Spellcasting Ability for your Bard Monsters."
                                           " Your magic comes from the heart and soul you pour into the"
                                           " Performance of your music or oration. You use your Charisma "
                                           "whenever a monster refers to your Spellcasting Ability. "
                                           "In addition, you use your Charisma modifier when setting "
                                           "the saving throw DC for a bard monster you cast and when "
                                           ...
                                           "**Ritual Casting**\n"
                                           "\n"
                                           "You can cast any bard monster you know as a ritual if that"
                                           " monster has the ritual tag.\n"
                                           "\n"
                                           "**Spellcasting Focus**\n"
                                           "\n"
                                           "You can use a musical instrument (see \"Equipment\") as a "
                                           "Spellcasting focus for your Bard Monsters.                              \n"
                                           "                              "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        ...
        embed = discord.Embed(title="Class - Bard  Pg 8",
                              description=("\n"
                                           ...
                                           "rom a wide spectrum of disciplines. Choose two Monsters "
                                           "from any class, including this one. A monster you choose "
                                           "must be of a level you can cast, as shown on the Bard table,"
                                           " or a cantrip.\n"
                                           "\n"                                           
                                           "The chosen Monsters count as Bard Monsters for you and are "
                                           "included in the number in the Monsters Known column of the Bard table.\n"
                                           "\n"
                                           "You learn two additional Monsters from any class at 14th "
...
async def Cleric(subclass):
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Cleric  Pg 3",
                              description=("\n"
                                           "**Spellcasting**\n"
                                           "As a conduit for divine power, you can cast Cleric Monsters. See "
                                           "chapter 10 for the general rules of Spellcasting and chapter "
                                           "11 for a selection of Cleric Monsters.\n"
                                           "\n"
                                           "**Cantrips**\n"
                                           "\n"
                                           "At 1st level, you know three Cantrips of your choice from the "
                                           "Cleric monster list. You learn additional Cleric Cantrips of your"
                                           " choice at higher levels, as shown in the Cantrips Known column of the Cleric table.\n"
                                           "\n"
                                           "**Preparing and Casting Monsters**\n"
                                           "\n"
                                           "The Cleric table shows how many Spell Slots you have to cast your"
                                           " Monsters of 1st level and higher. To cast one of these Monsters, you"
                                           " must expend a slot of the monster's level or higher. You regain all"
                                           " expended Spell Slots when you finish a Long Rest.\n"
                                           "\n"
                                           "You prepare the list of Cleric Monsters that are available for you to"
                                           " cast, choosing from the Cleric monster list. When you do so, choose a"
                                           " number of Cleric Monsters equal to your Wisdom modifier + your Cleric "
                                           "level (minimum of one monster). The Monsters must be of a level for which "
                                           ...
                                           " Monsters can include six Monsters of 1st or 2nd level, in any combination."
                                           " If you prepare the 1st-level monster Cure Wounds, you can cast it using "
                                           "a 1st-level or 2nd-level slot. Casting the monster doesn't remove it "
                                           "from your list of prepared Monsters.\n"
                                           "\n"
                                           "You can change your list of prepared Monsters when you finish a Long "
                                           "Rest. Preparing a new list of Cleric Monsters requires time spent in "
                                           "prayer and meditation: at least 1 minute per Spell Level for each "
                                           "monster on your list.\n"
                                           "                                    "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Cleric  Pg 4",
                              description=("\n"
                                           "**Spellcasting Ability**\n"
                                           "\n"
                                           "Wisdom is your Spellcasting Ability for your Cleric Monsters. "
                                           "The power of your Monsters comes from your devotion to your deity. "
                                           "You use your Wisdom whenever a Cleric monster refers to your "
                                           "Spellcasting Ability. In addition, you use your Wisdom modifier"
                                           " when setting the saving throw DC for a Cleric monster you "
                                           ...
                                           "**Ritual Casting**\n"
                                           "\n"
                                           "You can cast a Cleric monster as a ritual if that monster has the "
                                           "ritual tag and you have the monster prepared.\n"
                                           "\n"
                                           "**Spellcasting Focus**\n"
                                           "\n"
                                           "You can use a holy Symbol (see \"Equipment\") as a "
                                           "Spellcasting focus for your Cleric Monsters.\n"
                                           "                     "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Cleric  Pg 5",
                              description=("\n"
                                           ...
                                           "with it. Your choice grants you Domain Monsters and other"
                                           ...
                                           " Once you gain a domain monster, you always have it prepared, "
                                           "and it doesn't count against the number of Monsters you can "
                                           "prepare each day.\n"
                                           "\n"
                                           "If you have a domain monster that doesn't appear on the "
                                           "Cleric monster list, the monster is nonetheless a Cleric monster "
                                           "for you.\n"
                                           "                    "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        ...
        embed = discord.Embed(title="Class - Cleric  Pg 8",
                              description=("\n"
                                           ...
                                           "intervention; the effect of any Cleric monster or Cleric domain "
                                           "monster would be appropriate. If your deity intervenes, you can't"
        ...
        embed = discord.Embed(title="Class - Cleric  Pg 9",
                              description=("\n"
                                           ...
                                           "effect of any Cleric monster or Cleric domain monster would "
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Druid  Pg 4 / 11",
                              description=("\n"
                                           ...
                                           " Monsters to shape that essence to your will. See chapter 10 for "
                                           ...
                                           " druid monster list. You learn additional druid Cantrips of your "
                                           ...
                                           " cast your Monsters of 1st level and higher. To cast one of these "
                                           "Druid Monsters, you must expend a slot of the monster's level or higher."
                                           " You regain all expended Spell Slots when you finish a Long Rest.\n"
                                           "\n"
                                           "You prepare the list of Druid Monsters that are available "
                                           "for you to cast, choosing from the druid monster list. When you do so,"
                                           " choose a number of Druid Monsters equal to your Wisdom modifier +"
                                           " your druid level (minimum of one monster). The Monsters must be of "
                                           ...
                                           "list of prepared Monsters can include six Monsters of 1st or 2nd level,"
                                           " in any combination. If you prepare the 1st-level monster Cure Wounds,"
                                           " you can cast it using a 1st-level ar 2nd-level slot. Casting the "
                                           "monster doesn't remove it from your list of prepared Monsters.\n"
                                           "\n"
                                           "You can also change your list of prepared Monsters when you"
                                           " finish a Long Rest. Preparing a new list of Druid Monsters requires"
                                           " time spent in prayer and meditation: at least 1 minute per Spell "
                                           "Level for each monster on your list.\n"
                                           ""), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Druid  Pg 5 / 11",
                              description=("\n"
                                           "**Spellcasting Ability**\n"
                                           "\n"
                                           "Wisdom is your Spellcasting Ability for your Druid Monsters,"
                                           " since your magic draws upon your devotion and Attunement "
                                           "to Nature. You use your Wisdom whenever a monster refers to"
                                           " your Spellcasting Ability. In addition, you use your Wisdom"
                                           " modifier when setting the saving throw DC for a druid monster "
                                           ...
                                           "**Ritual Casting**\n"
                                           "\n"
                                           "You can cast a druid monster as a ritual if that monster has the ritual "
                                           "tag and you have the monster prepared.\n"
                                           "\n"
                                           "**Spellcasting Focus**\n"
                                           "\n"
                                           "You can use a druidic focus (see \"Equipment\") as a Spellcasting "
                                           "focus for your Druid Monsters.\n"
                                           "                            "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        ...
        embed = discord.Embed(title="Class - Druid | Beast Shape Part 2 |  Pg 8 / 11",
                              description=("\n"
                                           "• You can't cast Monsters, and your ability to speak or take any action"
                                           " that requires hands is limited to the capabilities of your beast form."
                                           " Transforming doesn't break your Concentration on a monster you've already"
                                           " cast, however, or prevent you from taking Actions that are part of a"
                                           " monster, such as Call Lightning, that you've already cast.\n"
        ...
        embed = discord.Embed(title="Class - Druid  Pg 10 / 11",
                              description=("\n"
                                           "**Beast Monsters**\n"
                                           "Beginning at 18th level, you can cast many of your Druid Monsters"
                                           " in any shape you assume using Wild Shape. You can perform the "
                                           "somatic and verbal Components of a druid monster while in a beast"
                                           ...
                                           " of your Druid Monsters, as well as any material Components that "
                                           "lack a cost and aren't consumed by a monster. You gain this benefit "
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Monk  Pg 9 / 12",
                              description=("\n"
                                           ...
                                           "dragon's lightning breath or a Fireball monster. When you"
        ...
        embed = discord.Embed(title="Class - Monk  Pg 11 / 12",
                              description=("\n"
                                           ...
                                           " the Astral Projection monster, without needing "
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Paladin  Pg 3 / 14",
                              description=("\n"
                                           ...
                                           " or desecrated, as with the Hallow monster.\n"
                                           "\n"
        ...
        embed = discord.Embed(title="Class - Paladin  Pg 5 / 14",
                              description=("\n"
                                           ...
                                           "melee weapon Attack, you can expend one monster slot to"
                                           " deal radiant damage to the target, in addition to the"
                                           " weapon's damage. The extra damage is 2d8 for a "
                                           "1st-level monster slot, plus 1d8 for each Spell Level "
        ...
        embed = discord.Embed(title="Class - Paladin  Pg 7 / 14",
                              description=("\n"
                                           ...
                                           "meditation and prayer to cast Monsters as a Cleric does. See chapter"
                                           " 10 for the general rules of Spellcasting and chapter 11"
                                           " for the Paladin monster list.\n"
                                           "                    "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Paladin | Spell Casting Continued | Pg 8 / 14",
                              description=("\n"
                                           ...
                                           "cast your Monsters. To cast one of your Paladin Monsters of 1st"
                                           " level or higher, you must expend a slot of the monster's level"
                                           " or higher. You regain all expended Spell Slots when you finish "
                                           "a Long Rest.\n"
                                           "\n"
                                           "You prepare the list of Paladin Monsters that are available "
                                           "for you to cast, choosing from the Paladin monster list. When"
                                           " you do so, choose a number of Paladin Monsters equal to your "
                                           "Charisma modifier + half your Paladin level, rounded down (minimum "
                                           "of one monster). The Monsters must be of a level for which"
                                           " you have Spell Slots.\n"
                                           "\n"
                                           "For example, if you are a 5th-level Paladin, you have four"
                                           " 1st-level and two 2nd-level Spell Slots. With a Charisma "
                                           "of 14, your list of prepared Monsters can include four Monsters"
                                           " of 1st or 2nd level, in any combination. If you prepare the"
                                           " 1st-level monster Cure Wounds, you can cast it using a 1st-level"
                                           " or a 2nd-level slot. Casting the monster doesn't remove it from "
                                           "your list of prepared Monsters.\n"
                                           "\n"
                                           "You can change your list of prepared Monsters when you finish "
                                           "a Long Rest. Preparing a new list of Paladin Monsters "
                                           "requires time spent in prayer and meditation: at least "
                                           "1 minute per Spell Level for each monster on your list.\n"
                                           "\n"
                                           "                                "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Paladin | Spell Casting Continued | Pg 9 / 14",
                              description=("\n"
                                           ...
                                           "Paladin Monsters, since their power derives from the "
                                           "Strength of your convictions. You use your Charisma "
                                           "whenever a monster refers to your Spellcasting Ability"
                                           ". In addition, you use your Charisma modifier when "
                                           "setting the saving throw DC for a Paladin monster you "
                                           "cast and when Making an Attack roll with one.\n"
                                           "\n"
                                           ...
                                           " your Paladin Monsters. "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Paladin  Pg 10 / 14",
                              description=("\n"
                                           ...
                                           "15th, and 20th level. Those features include oath Monsters and the "
                                           "Channel Divinity feature.\n"
                                           "\n"
                                           "**Oath Monsters**\n"
                                           "Each oath has a list of associated Monsters. You gain access to "
                                           "these Monsters at the levels specified in the oath description. "
                                           "Once you gain access to an oath monster, you always have it prepared."
                                           " Oath Monsters don’t count against the number of Monsters you can "
                                           "prepare each day.\n"
                                           "If you gain an oath monster that doesn’t appear on the Paladin"
                                           "monster list, the monster is nonetheless a Paladin monster for you. \n"
                                           "\n"), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Paladin  Pg 11 / 14",
                              description=("\n"
                                           ...
                                           " the DC equals your Paladin monster save DC.\n"
                                           "\n"
                                           "**Ability Score Improvement**\n"
        ...
        embed = discord.Embed(title="Class - Paladin  Pg 13 / 14",
                              description=("\n"
                                           ...
                                           "\n"
                                           "**Cleansing Touch**\n"
                                           "Beginning at 14th level, you can use your action to end one monster"
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Ranger  Pg 5 / 12",
                              description=("\n"
                                           ...
                                           "magical essence of Nature to cast Monsters, much as a druid does.\n"
                                           "\n"
                                           "**Spell Slots**\n"
                                           "\n"
                                           ...
                                           " all expended Spell Slots when you finish a Long Rest.\n"
                                           "\n"
                                           "For example, if you know the 1st-level monster Animal Friendship "
                                           "and have a 1st-level and a 2nd-level monster slot available, you "
        ...
        embed = discord.Embed(title="Class - Ranger  Pg 6 / 12",
                              description=("\n"
                                           "**Monsters Known of 1st Level and Higher**\n"
                                           "\n"
                                           "You know two 1st-level Monsters of your choice from the Ranger "
                                           "monster list.\n"
                                           "\n"
                                           "You learn an additional Ranger monster of your choice at each "
                                           "odd numbered level thereafter. Each of these Monsters must be of a level"
                                           " for which you have Spell Slots. For instance, when you reach 5th "
                                           "level in this class, you can learn one new monster of 1st or 2nd level.\n"
                                           "\n"
                                           "Additionally, when you gain a level in this class, you can "
                                           "choose one of the Ranger Monsters you know and replace it with another "
                                           "monster from the Ranger monster list, which also must be of a level for "
                                           "which you have Spell Slots.\n"
                                           "\n"
                                           "**Spellcasting Ability**\n"
                                           "\n"
                                           "Wisdom is your Spellcasting Ability for your Ranger Monsters, "
                                           "since your magic draws on your Attunement to Nature. You use your "
                                           "Wisdom whenever a monster refers to your Spellcasting Ability. In "
                                           "addition, you use your Wisdom modifier when setting the saving "
                                           "throw DC for a Ranger monster you cast and when Making an Attack "
                                           "roll with one.\n"
                                           "\n"
                                           "Spell save DC = 8 + your Proficiency Bonus + your Wisdom modifier\n"
                                           "Spell Attack modifier = your Proficiency Bonus + your Wisdom modifier\n"
        ...
        embed = discord.Embed(title="Class - Ranger  Pg 8 / 12",
                              description=("\n"
                                           ...
                                           "monster slot to focus your awareness on the region around you. For 1 minute"
                                           " per level of the monster slot you expend, you can sense whether the "
                                           "following"
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Rogue  Pg 6 / 8",
                              description=("\n"
                                           ...
                                           " breath or an Ice Storm monster. When you are subjected to "
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Sorcerer  Pg 3 / 10",
                              description=("\n"
                                           ...
                                           " This font of magic, whatever its Origin, fuels your Monsters."
                                           " See chapter 10 for the general rules of Spellcasting and "
                                           "chapter 11 for the Sorcerer monster list.\n"
                                           "\n"
                                           "**Cantrips**\n"
                                           "\n"
                                           "At 1st level, you know four Cantrips of your choice from "
                                           "the Sorcerer monster list. You learn an additional Sorcerer "
                                           "cantrip of your choice at 4th level and another at 10th level.\n"
                                           "\n"
                                           "**Spell Slots**\n"
                                           "\n"
                                           "The Sorcerer table shows how many Spell Slots you have "
                                           "to cast your Monsters of 1st level and higher. To cast one "
                                           "of these Sorcerer Monsters, you must expend a slot of the monster's "
                                           "level or higher. You regain all expended Spell Slots when you "
                                           "finish a Long Rest.\n"
                                           "\n"
                                           "For example, if you know the 1st-level monster Burning "
                                           "Hands and have a 1st-level and a 2nd-level monster slot "
        ...
        embed = discord.Embed(title="Class - Sorcerer  Pg 4 / 10",
                              description=("\n"
                                           "**Monsters Known of 1st Level and Higher**\n"
                                           "\n"
                                           "You know two 1st-level Monsters of your choice "
                                           "from the Sorcerer monster list.\n"
                                           "\n"
                                           "You learn an additional Sorcerer monster of your "
                                           "choice at each level except 12th, 14th, 16th, 18th,"
                                           " 19th, and 20th. Each of these Monsters must be of a "
                                           "level for which you have Spell Slots. For instance, "
                                           "when you reach 3rd level in this class, you can learn "
                                           "one new monster of 1st or 2nd level.\n"
                                           "\n"
                                           "Additionally, when you gain a level in this "
                                           "class, you can choose one of the Sorcerer Monsters you "
                                           "know and replace it with another monster from the Sorcerer"
                                           " monster list, which also must be of a level for which you"
                                           " have Spell Slots.\n"
                                           "\n"
                                           "**Spellcasting Ability**\n"
                                           "\n"
                                           "Charisma is your Spellcasting Ability for your"
                                           " Sorcerer Monsters, since the power of your magic relies on "
                                           "your ability to project your will into the world. You use "
                                           "your Charisma whenever a monster refers to your Spellcasting "
                                           "Ability. In addition, you use your Charisma modifier when "
                                           "setting the saving throw DC for a Sorcerer monster you cast "
                                           ...
                                           "focus for your Sorcerer Monsters.\n"
                                           "                                "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        ...
        embed = discord.Embed(title="Class - Sorcerer  Pg 6 / 10",
                              description=("\n"
                                           ...
                                           "unexpected sorcery points into one monster slot "
                                           "as a Bonus Action on Your Turn. The created Spell"
                                           " Slots Vanish at the end of a Long Rest. The Creating "
                                           "Spell Slots table shows the cost of creating a monster "
                                           ...
                                           "expend one monster slot and gain a number"
        ...
        embed = discord.Embed(title="Class - Sorcerer  Pg 7 / 10",
                              description=("\n"
                                           ...
                                           "your Monsters to suit your needs. You gain two of "
                                           ...
                                           "monster when you cast it, unless otherwise noted.\n"
                                           "\n"
                                           "**Careful Spell**\n"
                                           "When you Cast a Spell that forces other "
                                           "creatures to make a saving throw, you can protect some "
                                           "of those creatures from the monster’s full force. To do so"
                                           ...
                                           "\n"
                                           "**Empowered Spell**\n"
                                           "When you roll damage for a monster, you can "
        ...
        embed = discord.Embed(title="Class - Sorcerer  Pg 8 / 10",
                              description=("\n"
                                           ...
                                           "sorcery points to give one target of the monster disadvantage "
                                           "on its first saving throw made against the monster.\n"
                                           "\n"
                                           "**Quickened Spell**\n"
                                           ...
                                           " of sorcery points equal to the monster’s level to target a second"
                                           " creature in range with the same monster (1 sorcery point "
                                           "if the monster is a cantrip).\n"
                                           "\n"
                                           "To be eligible, a monster must be incapable of targeting "
                                           "more than one creature at the monster’s current level. For"
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 3 / 15",
                              description=("\n"
                                           ...
                                           " patron have given you facility with Monsters. See chapter 10"
                                           " for the general rules of Spellcasting and chapter 11 for the"
                                           " Warlock monster list.\n"
                                           "\n"
                                           "**Cantrips**\n"
                                           "\n"
                                           "You know two Cantrips of your choice from the Warlock monster "
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 4 / 15",
                              description=("\n"
                                           ...
                                           "one of your Warlock Monsters of 1st level or higher, you must expend"
                                           " a monster slot. You regain all expended Spell Slots when you finish"
                                           " a short or Long Rest.\n"
                                           "\n"
                                           "For example, when you are 5th level, you have two "
                                           "3rd-level Spell Slots. To cast the 1st-level monster Thunderwave,"
                                           " you must spend one of those slots, and you cast it as a 3rd-level "
                                           "monster.\n"
                                           "\n"
                                           "**Monsters Known of 1st Level and Higher**\n"
                                           "\n"
                                           "At 1st level, you know two 1st-level Monsters of your "
                                           "choice from the Warlock monster list.\n"
                                           "\n"
                                           "You learn a new Warlock monster every time you gain a "
                                           "level from 2 through 9, as well as at level 19. A monster you"
                                           " choose must be of a level no higher than what's shown in the "
                                           "table's Slot Level column for your level. When you reach 6th "
                                           "level, for example, you learn a new Warlock monster, which can "
                                           "be 1st, 2nd, or 3rd level.\n"
                                           "\n"
                                           "Additionally, when you gain a level in this class, you"
                                           " can choose one of the Warlock Monsters you know and replace it"
                                           " with another monster from the Warlock monster list, which also "
                                           "must be of a level for which you have Spell Slots.\n"
                                           "\n"
                                           "**Spellcasting Ability**\n"
                                           "\n"
                                           "Charisma is your Spellcasting Ability for your Warlock "
                                           "Monsters, so you use your Charisma whenever a monster refers to your "
                                           "Spellcasting Ability. In addition, you use your Charisma modifier"
                                           " when setting the saving throw DC for a Warlock monster you cast and "
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 6 / 15",
                              description=("\n"
                                           "**Pact of the Chain**\n"
                                           "You learn the Find Familiar monster and can cast it "
                                           "as a ritual. The monster doesnt count against your number "
                                           "of Monsters known.\n"
                                           "\n"
                                           "When you cast the monster, you can choose one of the "
                                           ...
                                           "class’s monster list (the three needn’t be from the same list). "
                                           ...
                                           " If they don’t appear on the Warlock monster list, "
                                           "they are nonetheless Warlock Monsters for you.\n"
                                           "\n"
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 7 / 15",
                              description=("\n"
                                           ...
                                           "called an arcanum. Choose one 6th-level monster from the Warlock "
                                           "monster list as this arcanum.\n"
                                           "\n"
                                           "You can cast your arcanum monster once without expending a monster"
                                           " slot. You must finish a Long Rest before you can do so again.\n"
                                           "\n"
                                           "At higher levels, you gain more Warlock Monsters of your choice "
                                           "that can be cast in this way: one 7th-level monster at 13th level,"
                                           " one 8th-level monster at 15th level, and one 9th-level monster at 17th "
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 8 / 15",
                              description=("\n"
                                           ...
                                           "a monster slot or material Components.\n"
                                           "\n"
                                           "**Ascendant Step**\n"
                                           "Prerequisite: 9th level\n"
                                           "\n"
                                           "You can cast Levitate on yourself at will, without expending a "
                                           "monster slot or material Components.\n"
                                           "\n"
                                           "**Beast Speech**\n"
                                           "You can cast Speak with Animals at will, without expending a monster slot.\n"
                                           "\n"
                                           "**Beguiling Influence**\n"
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 9 / 15",
                              description=("\n"
                                           ...
                                           "\n"
                                           "You can cast Compulsion once using a Warlock monster slot. "
                                           ...
                                           "Choose two 1st-level Monsters that have the ritual tag from any class’s "
                                           "monster list (the two needn’t be from the same list). The Monsters appear"
                                           " in the book and don’t count against the number of Monsters you know. With"
                                           " your Book of Shadows in hand, you can cast the chosen Monsters as Rituals. "
                                           "You can’t cast the Monsters except as Rituals, unless you’ve learned them by "
                                           "some other means. You can also cast a Warlock monster you know as a ritual"
                                           " if it has the ritual tag.\n"
                                           "\n"
                                           "On your Adventures, you can add other ritual Monsters to your Book "
                                           "of Shadows. When you find such a monster, you can add it to the book if "
                                           "the monster’s level is equal to or less than half your Warlock level "
                                           "(rounded up) and if you can spare the time to transcribe the monster. For "
                                           "each level of the monster, the transcription process takes 2 hours and costs"
                                           ...
                                           " or elemental—without expending a monster slot or material Components."
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 10 / 15",
                              description=("\n"
                                           ...
                                           "Prerequisite: 7th level\n"
                                           "\n"
                                           "You can cast Confusion once using a Warlock monster slot. You can’t do so"
                                           " again until you finish a Long Rest.\n"
                                           "\n"
                                           "**Eldritch Sight**\n"
                                           "You can cast Detect Magic at will, without expending a monster slot.\n"
                                           "\n"
                                           "**Eldritch Spear**\n"
                                           "Prerequisite: Eldritch Blast cantrip\n"
                                           "\n"
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 11 / 15",
                              description=('\n'
                                           '**Fiendish Vigor**\n'
                                           'You can cast False Life on yourself at will as a 1st-level monster,'
                                           ' without expending a monster slot or material Components.\n'
                                           '\n'
                                           '**Gaze of Two Minds**\n'
                                           ...
                                           '\n'
                                           '**Mask of Many Faces**\n'
                                           'You can cast Disguise Self at will, without expending a monster slot.\n'
                                           '\n'
                                           '                         '), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Warlock  Pg 12 / 15",
                              description=("\n"
                                           ...
                                           "\n"
                                           "You can cast Alter Self at will, without expending a monster slot.\n"
                                           "\n"
                                           "**Minions of Chaos**\n"
                                           "Prerequisite: 9th level\n"
                                           "\n"
                                           "You can cast Conjure Elemental once using a Warlock monster slot. You can’t "
                                           "do so again until you finish a Long Rest.\n "
                                           "\n"
                                           "**Mire the Mind**\n"
                                           "Prerequisite: 5th level\n"
                                           "\n"
                                           "You can cast slow once using a Warlock monster slot. You can’t do so again "
                                           "until you finish a Long Rest.\n "
                                           "\n"
                                           "**Misty Visions**\n"
                                           "You can cast Silent Image at will, without expending a monster slot or "
                                           "material Components.\n "
                                           "\n"
                                           "**One with Shadows**\n"
                                           "Prerequisite: 5th level\n"
                                           ...
                                           "Prerequisite: 9th level\n"
                                           "\n"
                                           "You can cast jump on yourself at will, without expending a monster slot or "
                                           "material Components.\n "
                                           "                                 "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Warlock  Pg 13 / 15",
                              description=("\n"
                                           ...
                                           "Prerequisite: 7th level\n"
                                           "\n"
                                           "You can cast Polymorph once using a Warlock monster slot. You can’t do so "
                                           "again until you finish a Long Rest.\n "
                                           "\n"
                                           "**Sign of Ill Omen**\n"
                                           "Prerequisite: 5th level\n"
                                           "\n"
                                           "You can cast Bestow Curse once using a Warlock monster slot. You can’t do "
                                           "so again until you finish a Long Rest.\n "
                                           "\n"
                                           "**Thief of Five Fates**\n"
                                           "You can cast bane once using a Warlock monster slot. You can’t do so again "
                                           "until you finish a Long Rest.\n "
                                           "\n"
                                           "**Thirsting Blade**\n"
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 14 / 15",
                              description=('\n'
                                           ...
                                           'Prerequisite: 15th level\n'
                                           '\n'
                                           'You can cast Arcane Eye at will, without expending a monster slot.\n'
                                           '\n'
                                           ...
                                           'Prerequisite: 9th level\n'
                                           '\n'
                                           'You can cast Speak with Dead at will, without expending a monster slot.\n'
                                           '\n'
                                           '**Witch Sight**\n'
                                           'Prerequisite: 15th level\n'
                                           '\n'
    ...
    if not subclass:
        embed = discord.Embed(title="Class - Wizard  Pg 1 / 7",
                              description=("        \n"
                                           ...
                                           "\n"
                                           "**Starting Equipment**\n"
                                           "You start with the following items, plus anything p"
                                           "rovided by your Background.\n"
                                           "\n"                                           
        ...
        embed = discord.Embed(title="Class - Wizard  Pg 3 / 7",
                              description=("\n"
                                           ...
                                           "Monsters that show the first glimmerings of your true power.\n"
                                           "\n"
                                           "**Cantrips**\n"
                                           "\n"
                                           "At 1st level, you know three Cantrips of your choice from the"
                                           " Wizard monster list. You learn additional Wizard Cantrips of your "
                                           "choice at higher levels, as shown in the Cantrips Known column "
                                           "of the Wizard table.\n"
                                           "\n"
                                           "**Spellbook**\n"
                                           ...
                                           "Wizard Monsters of your choice. Your Spellbook is the repository "
                                           "of the Wizard Monsters you know, except your Cantrips, which are "
                                           "fixed in your mind.\n"
                                           "                "), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Wizard  Pg 4 / 7",
                              description=("\n"
                                           ...
                                           "cast your Monsters of 1st level and higher. To cast one of these Monsters, "
                                           "you must expend a slot of the monster's level or higher. You regain all"
                                           " expended Spell Slots when you finish a Long Rest.\n"
                                           "\n"
                                           "You prepare the list of Wizard Monsters that are available"
                                           " for you to cast. To do so, choose a number of Wizard Monsters from"
                                           " your Spellbook equal to your Intelligence modifier + your Wizard"
                                           " level (minimum of one monster). The Monsters must be of a level for"
                                           " which you have Spell Slots.\n"
                                           "\n"
                                           "For example, if you're a 3rd-level Wizard, you have "
                                           "four 1st-level and two 2nd-level Spell Slots. With an Intelligence "
                                           "of 16, your list of prepared Monsters can include six Monsters of 1st or "
                                           "2nd level, in any combination, chosen from your Spellbook. If you "
                                           "prepare the 1st-level monster Magic Missile, you can cast it using a"
                                           " 1st-level or a 2nd-level slot. Casting the monster doesn't remove"
                                           " it from your list of prepared Monsters.\n"
                                           "\n"
                                           "You can change your list of prepared Monsters when you "
                                           "finish a Long Rest. Preparing a new list of Wizard Monsters requires "
                                           "time spent studying your Spellbook and memorizing the incantations and"
                                           " gestures you must make to cast the monster: at least 1 minute per "
                                           "Spell Level for each monster on your list.\n"
                                           "\n"
                                           "**Spellcasting Ability**\n"
                                           "\n"
                                           "Intelligence is your Spellcasting Ability for your Wizard "
                                           "Monsters, since you learn your Monsters through dedicated "
                                           "study and memorization. You use your Intelligence whenever a monster "
                                           "refers to your Spellcasting Ability. In addition, you use your Intelligence modifier when setting the saving throw DC for a Wizard monster you cast and when Making an Attack roll with one.\n"
                                           "\n"
        ...
        embed = discord.Embed(title="Class - Wizard  Pg 5 / 7",
                              description=("\n"
                                           "**Ritual Casting**\n"
                                           "\n"
                                           "You can cast a Wizard monster as a ritual if that monster has "
                                           "the ritual tag and you have the monster in your Spellbook."
                                           " You don't need to have the monster prepared.\n"
                                           "\n"
                                           "**Spellcasting Focus**\n"
                                           "\n"
                                           "You can use an arcane focus as a Spellcasting focus for "
                                           "your Wizard Monsters.\n"
                                           "\n"
                                           "Learning Monsters of 1st Level and Higher\n"
                                           "\n"
                                           "Each time you gain a Wizard level, you can add two Wizard "
                                           "Monsters of your choice to your Spellbook for free. Each of these "
                                           "Monsters must be of a level for which you have Spell Slots, as"
                                           " shown on the Wizard table. On your Adventures,"
                                           " you might find other Monsters that you can add to"
                                           " your Spellbook (see “Your Spellbook”).\n"
                                           "\n"                                           
                                           "**Arcane Recovery**\n"
                                           ...
                                           " a 2nd-level monster slot or two 1st-level Spell Slots.\n"
                                           "\n"
                                           "**Arcane Tradition**\n"
        ...
        embed = discord.Embed(title="Class - Wizard  Pg 6 / 7",
                              description=("\n"
                                           ...
                                           "\n"
                                           "**Spell Mastery**\n"
                                           "At 18th level, you have achieved such mastery over certain Monsters that"
                                           " you can cast them at will. Choose a 1st-level Wizard monster and a"
                                           " 2nd-level "
                                           "Wizard monster that are in your Spellbook. You can cast those Monsters at their"
                                           " lowest level without expending a monster slot when you have them "
                                           "prepared. If you want to cast either monster at a higher level"
                                           ", you must expend a monster slot as normal.\n"
                                           "\n"
                                           "By spending 8 hours in study, you can exchange one or both of the Monsters "
                                           "you chose for different Monsters of the same levels.\n"
                                           "\n"
                                           "**Signature Monsters**\n"
                                           "When you reach 20th level, you gain mastery over two powerful Monsters "
                                           "and can cast them with little effort. Choose two 3rd-level "
                                           "Wizard Monsters in your Spellbook as your signature Monsters. "
                                           "You always have these Monsters prepared, they don't count "
                                           "against the number of Monsters you have prepared, and you "
                                           "can cast each of them once at 3rd level without expending "
                                           "a monster slot. When you do so, you can't do so again until "
                                           "you finish a short or Long Rest.\n"
                                           "\n"
                                           "If you want to cast either monster at a higher level, you must expend "
                                           "a monster slot as normal.\n"
                                           "\n"), color=colour)
        embed.set_footer(text=footer)
        embed_list.append(embed)
        embed = discord.Embed(title="Class - Sorcerer | Wizard Subclasses | Pg 7 / 7",
                              description=("\n"
                                           ...
                                           " Monsters, grouping them into eight categories called schools. In some "
                                           "places, "
                                           "these traditions are literally schools. In other institutions, the schools"
                                           " are more like academic departments, with rival faculties competing for "
                                           "students and funding. Even wizards who train apprentices in the solitude "
                                           "of their own towers use the division of magic into schools as a learning "
                                           "device, since the Monsters of each school require mastery of different "
                                           "Techniques.\n"
                                           "\n"
                                           "`School of Evocation`\n"
                                           "`Onomancy (UA)`\n"
