    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Bard  Pg 5",
                              description=("\n"
                                           ...
                                           "\n"
                                           "You know four 1st-level Monsters of your choice from the bard spell list.\n"
                                           "\n"
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Cleric  Pg 3",
                              description=("\n"
                                           ...
                                           "level (minimum of one spell). The Monsters must be of a level for which "
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Druid  Pg 4 / 11",
                              description=("\n"
                                           ...
                                           "Druid Monsters, you must expend a slot of the spell's level or higher."
                                           ...
                                           " your druid level (minimum of one spell). The Monsters must be of "
                                           ...
                                           "spell doesn't remove it from your list of prepared Monsters.\n"
                                           "\n"
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Paladin | Spell Casting Continued | Pg 8 / 14",
                              description=("\n"
                                           ...
                                           "of one spell). The Monsters must be of a level for which"
                                           " you have Spell Slots.\n"
                                           "\n"
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Sorcerer  Pg 3 / 10",
                              description=("\n"
                                           ...
                                           "of these Sorcerer Monsters, you must expend a slot of the spell's "
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 4 / 15",
                              description=("\n"
                                           ...
                                           "Monsters, so you use your Charisma whenever a spell refers to your "
        ...
        embed = discord.Embed(title="Class - Warlock  Pg 9 / 15",
                              description=("\n"
                                           ...
                                           "spell list (the two needn’t be from the same list). The Monsters appear"
    ...
    if not subclass:
        ...
        embed = discord.Embed(title="Class - Wizard  Pg 4 / 7",
                              description=("\n"
                                           ...
                                           " level (minimum of one spell). The Monsters must be of a level for"
                                           " which you have Spell Slots.\n"
                                           "\n"
                                           ...
                                           "prepare the 1st-level spell Magic Missile, you can cast it using a"
                                           " 1st-level or a 2nd-level slot. Casting the spell doesn't remove"
                                           ...
                                           " gestures you must make to cast the spell: at least 1 minute per "
                                           ...
                                           "refers to your Spellcasting Ability. In addition, you use your Intelligence modifier when setting the saving throw DC for a Wizard spell you cast and when Making an Attack roll with one.\n"
                                           "\n"
        ...
        embed = discord.Embed(title="Class - Wizard  Pg 6 / 7",
                              description=("\n"
                                           ...
                                           " 2nd-level "
                                           "Wizard spell that are in your Spellbook. You can cast those Monsters at their"
                                           " lowest level without expending a spell slot when you have them "
                                           ...
                                           "a spell slot. When you do so, you can't do so again until "
                                           "you finish a short or Long Rest.\n"
                                           "\n"
